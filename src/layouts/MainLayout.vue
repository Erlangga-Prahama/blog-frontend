...
<template>
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <nav class="flex items-center gap-4">
          <template v-if="isAuthenticated">
            <RouterLink :to="{ name: 'dashboard' }" class="text-sm text-gray-600 hover:text-indigo-600">
              Dashboard
            </RouterLink>
          ...
          <template v-else>
            <RouterLink to="/login" class="text-sm text-gray-600 hover:text-indigo-600">
              Masuk
            </RouterLink>
    ...
    <div class="max-w-7xl mx-auto px-4 py-6" :class="route.meta.showSidebar ? 'flex gap-6' : ''">
      <aside
        v-if="route.meta.showSidebar"
